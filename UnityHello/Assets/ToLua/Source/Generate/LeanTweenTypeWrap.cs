...
public class LeanTweenTypeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.EndEnum();
		TypeTraits<LeanTweenType>.Check = CheckType;
		StackTraits<LeanTweenType>.Push = Push;
	}

	static void Push(IntPtr L, LeanTweenType arg)
	{
		ToLua.Push(L, arg);
	}
	...
	{
		return TypeChecker.CheckEnumType(typeof(LeanTweenType), L, pos);
	}
